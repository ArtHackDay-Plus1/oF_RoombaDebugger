...
namespace MacroManager {
    ...
    const float frame_to_wall_w = 485;
    const float frame_to_wall_h = 435;
    
    const float kinect_width = 200;
    const float kinect_height = 50;
    const float distance_kinect_to_frame = -1400;
    ...
    const float scaling_frame_to_wall_w = 97;
    const float scaling_frame_to_wall_h = 87;
    
    const float scaling_kinect_width = 40;
    const float scaling_kinect_height = 10;
    const float scaling_distance_kinect_to_frame = -280;
};
